...
export const envSchema = {
    type: 'object',
    required: ['PORT', 'MONGODB_URI', 'SUPER_ADMIN', 'SUPER_ADMIN_PASSWORD', 'HOST_MAILTRAP', 'PORT_MAILTRAP', 'USER_MAILTRAP', 'PASS_MAILTRAP', 'JWT_SECRET', 'CLOUDINARY_CLOUD_NAME', 'CLOUDINARY_API_KEY', 'CLOUDINARY_API_SECRET'],
    properties: {
